...
import cn.greeston.orm.dialect.Dialect;
import cn.greeston.orm.page.PageSort;
import cn.greeston.orm.page.Sort;
import cn.greeston.orm.util.PropertiesUtil;
import cn.greeston.orm.util.ReflectionUtils;
...
public class OffsetLimitInterceptor implements Interceptor {
    ...
    void processHasPageParameter(final Object[] queryArgs){
        ...
        //设置了一些其他值
        ReflectionUtils.setFieldValue(newBoundSql, "metaParameters",
                ReflectionUtils.getFieldValue(boundSql, "metaParameters"));
